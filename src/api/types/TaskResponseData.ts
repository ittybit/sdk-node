...
export interface TaskResponseData {
    ...
    kind: Ittybit.TaskResponseDataKind;
    ...
    status: Ittybit.TaskResponseDataStatus;
    ...
    workflow?: Ittybit.TaskResponseDataWorkflowItem[];
    /** Array representing subsequent tasks (e.g., in an automation). Structure may vary. */
    next?: Ittybit.TaskResponseDataNextItem[];
    results?: Ittybit.TaskResponseDataResults;
}
