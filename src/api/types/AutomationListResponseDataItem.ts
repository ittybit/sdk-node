...
export interface AutomationListResponseDataItem {
    ...
    trigger: Ittybit.AutomationListResponseDataItemTrigger;
    ...
    workflow: Ittybit.AutomationListResponseDataItemWorkflowItem[];
    /** Current status of the automation */
    status: Ittybit.AutomationListResponseDataItemStatus;
