 ...
 */
export interface MediaListResponseDataItemSourcesItem {
    ...
    kind: Ittybit.MediaListResponseDataItemSourcesItemKind;
    ...
    height?: number;
    /** Visual orientation. */
    orientation?: Ittybit.MediaListResponseDataItemSourcesItemOrientation;
    /** Duration in seconds. */
    duration?: number;
    /** Frames per second. */
    fps?: number;
