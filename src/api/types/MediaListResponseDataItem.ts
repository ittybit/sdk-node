...
export interface MediaListResponseDataItem {
    ...
    kind: Ittybit.MediaListResponseDataItemKind;
    ...
    sources: Ittybit.MediaListResponseDataItemSourcesItem[];
    ...
    updated: string;
    /** Processing status. */
    status: Ittybit.MediaListResponseDataItemStatus;
}
