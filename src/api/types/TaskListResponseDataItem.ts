...
export interface TaskListResponseDataItem {
    /** Unique identifier for the task. */
    id: string;
    /** Object type, always 'task'. */
    object: string;
    /** The type of operation the task performs. */
    kind: Ittybit.TaskListResponseDataItemKind;
    ...
    status: Ittybit.TaskListResponseDataItemStatus;
    ...
    workflow?: Ittybit.TaskListResponseDataItemWorkflowItem[];
    /** Array representing subsequent tasks (e.g., in an automation). Structure may vary. */
    next?: Ittybit.TaskListResponseDataItemNextItem[];
    results?: Ittybit.TaskListResponseDataItemResults;
}
