...
export interface TasksCreateResponseData {
    /** Unique identifier for the task. */
    id: string;
    /** Object type, always 'task'. */
    object: string;
    /** The type of operation the task performs. */
    kind: Ittybit.TasksCreateResponseDataKind;
    ...
    status: Ittybit.TasksCreateResponseDataStatus;
    ...
    workflow?: Ittybit.TasksCreateResponseDataWorkflowItem[];
    /** Array representing subsequent tasks (e.g., in an automation). Structure may vary. */
    next?: Ittybit.TasksCreateResponseDataNextItem[];
    results?: Ittybit.TasksCreateResponseDataResults;
}
