...
export interface TasksListFilteredResponseDataItemWorkflowItem {
    /** Unique identifier for the task. */
    id: string;
    /** Object type, always 'task'. */
    object: string;
    /** The type of operation the task performs. */
    kind: Ittybit.TasksListFilteredResponseDataItemWorkflowItemKind;
    /** Current status of the task. */
    status: Ittybit.TasksListFilteredResponseDataItemWorkflowItemStatus;
