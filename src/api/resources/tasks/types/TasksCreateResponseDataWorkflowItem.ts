...
export interface TasksCreateResponseDataWorkflowItem {
    /** Unique identifier for the task. */
    id: string;
    /** Object type, always 'task'. */
    object: string;
    /** The type of operation the task performs. */
    kind: Ittybit.TasksCreateResponseDataWorkflowItemKind;
    /** Current status of the task. */
    status: Ittybit.TasksCreateResponseDataWorkflowItemStatus;
