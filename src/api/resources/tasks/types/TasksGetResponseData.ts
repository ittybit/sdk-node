...
export interface TasksGetResponseData {
    /** Unique identifier for the task. */
    id: string;
    /** Object type, always 'task'. */
    object: string;
    /** The type of operation the task performs. */
    kind: Ittybit.TasksGetResponseDataKind;
    ...
    status: Ittybit.TasksGetResponseDataStatus;
    ...
    workflow?: Ittybit.TasksGetResponseDataWorkflowItem[];
    /** Array representing subsequent tasks (e.g., in an automation). Structure may vary. */
    next?: Ittybit.TasksGetResponseDataNextItem[];
    results?: Ittybit.TasksGetResponseDataResults;
}
