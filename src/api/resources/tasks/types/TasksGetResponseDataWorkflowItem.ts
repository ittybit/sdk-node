...
export interface TasksGetResponseDataWorkflowItem {
    /** Unique identifier for the task. */
    id: string;
    /** Object type, always 'task'. */
    object: string;
    /** The type of operation the task performs. */
    kind: Ittybit.TasksGetResponseDataWorkflowItemKind;
    /** Current status of the task. */
    status: Ittybit.TasksGetResponseDataWorkflowItemStatus;
