...
export interface TasksListFilteredResponseDataItemNextItem {
    /** Unique identifier for the task. */
    id: string;
    /** Object type, always 'task'. */
    object: string;
    /** The type of operation the task performs. */
    kind: Ittybit.TasksListFilteredResponseDataItemNextItemKind;
    /** Current status of the task. */
    status: Ittybit.TasksListFilteredResponseDataItemNextItemStatus;
