 ...
 */
export interface MediaCreateResponseDataSourcesItem {
    ...
    kind: Ittybit.MediaCreateResponseDataSourcesItemKind;
    ...
    height?: number;
    /** Visual orientation. */
    orientation?: Ittybit.MediaCreateResponseDataSourcesItemOrientation;
    /** Duration in seconds. */
    duration?: number;
    /** Frames per second. */
    fps?: number;
