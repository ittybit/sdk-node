...
export interface MediaGetResponseData {
    ...
    kind: Ittybit.MediaGetResponseDataKind;
    ...
    sources: Ittybit.MediaGetResponseDataSourcesItem[];
    ...
    updated: string;
    /** Processing status. */
    status: Ittybit.MediaGetResponseDataStatus;
}
