 ...
 */
export interface MediaGetResponseDataSourcesItem {
    ...
    kind: Ittybit.MediaGetResponseDataSourcesItemKind;
    ...
    height?: number;
    /** Visual orientation. */
    orientation?: Ittybit.MediaGetResponseDataSourcesItemOrientation;
    /** Duration in seconds. */
    duration?: number;
    /** Frames per second. */
    fps?: number;
