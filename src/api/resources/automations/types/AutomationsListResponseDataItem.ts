...
export interface AutomationsListResponseDataItem {
    ...
    trigger: Ittybit.AutomationsListResponseDataItemTrigger;
    ...
    workflow: Ittybit.AutomationsListResponseDataItemWorkflowItem[];
    /** Current status of the automation */
    status: Ittybit.AutomationsListResponseDataItemStatus;
