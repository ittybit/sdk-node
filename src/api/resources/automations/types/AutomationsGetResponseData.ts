...
export interface AutomationsGetResponseData {
    ...
    trigger: Ittybit.AutomationsGetResponseDataTrigger;
    ...
    workflow: Ittybit.AutomationsGetResponseDataWorkflowItem[];
    /** Current status of the automation */
    status: Ittybit.AutomationsGetResponseDataStatus;
