...
export interface AutomationsCreateResponseData {
    ...
    trigger: Ittybit.AutomationsCreateResponseDataTrigger;
    ...
    workflow: Ittybit.AutomationsCreateResponseDataWorkflowItem[];
    /** Current status of the automation */
    status: Ittybit.AutomationsCreateResponseDataStatus;
